...
.Game effects
Treat as impassable terrain for all units -- and perhaps treat as dangerous terrain for all units that pass within 5 cm.
...
Treat it as impassable terrain for Infantry and/or Vehicle units, and as dangerous terrain for War Engine units.
