...
A powerful force seeks to overwhelm a defensive position before enemy reinforcements can turn the tide of battle.
The opposing defensive force is smaller but well-prepared to hold the line until reinforcements arrive.
The attackers must be bold to navigate minefields and booby-traps and to find the defenders in their concealed positions and overrun them.
...
* Standard deployment edges, but the Defender can also bring Reserves into play along adjacent edges that extend to the half-way line -- refer to the maps.
* The Defender's deployment zone extends from their deployment edge to half-way across the table.
...
So, if you did not roll 4–6 for any of your detachments then you must choose which detachment you will deploy during initial deployment.
...
. *Attacker*: Deploy in the Attacker's deployment zone [.conum]#A# (see <<Maps>>).
