...
This scenario exists mainly for an introductory experience with the <<Historical forces>>.

We have made no attempt to include instructions for more general usage.
Don't be afraid to adapt this scenario yourself though, even if only to suit the miniatures that you currently have in your collection.
