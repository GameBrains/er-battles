...
* The Defender's deployment zone is based on ruins near the centre of the playing area.
* The Defender has a pre-determined deployment edge.
* Roads that converge at a 'Y' junction in the centre of the playing area.
* Seven areas of ruins.
...
* Swap heavy weapons infantry for more tanks: Simply drop _Force Adonis_ and add another armoured detachment like _Force Citus_ instead.
* Swap tanks for more heavy weapons infantry: Simply drop _Force Citus_ and add another detachment like _Force Adonis_ instead.
...
{blank}[TODO: Create new data sheet for _Korps Grinda_/Great Gargant. In the meantime, see https://thehobby.zone/resources/e40k-compendium/Content/Resources/Images/Illustrations/BattlesBook/Refight1GogardsLastStand_KorpsGrindaDataCard.gif[^]]
