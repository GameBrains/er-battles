...
image::map-refight-2-rescue.svg[alt="Deployment map for the Rescue scenario",600,450]

[none]
.Legend
* [.conum]#A# Attacker's deployment zone.
* [.conum]#G# Defender's garrison deployment zone.
...
* *Attacker*: You have no objectives as such -- rather, you must thwart the Defender as they attempt to move their Rescue objective marker off of their deployment edge, and gain control of it if you can.
* *Defender*: You have a single Rescue objective.
. *Defender*: Place your Rescue objective marker anywhere within the Defender's garrison deployment zone [.conum]#G# (see <<Maps>>).
...
* Deploy within the Defender's garrison deployment zone [.conum]#G# (see <<Maps>>).
