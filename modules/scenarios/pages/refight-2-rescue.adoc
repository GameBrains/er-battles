...
We believe that the designers intended a larger-than-usual playing area for this scenario.
...
The force that you deploy in garrison deployment zone [.conum]#D# needs to be able to hold it's own until your relief force can help them.
