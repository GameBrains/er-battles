...
* The Attacker has two 'flanking deployment edges', one adjacent to each area of foothills.
(The Attacker will choose *one* of these to use -- but the Defender will not know which until the Attacker's flanking force arrives.)
footnote:[{e40k-diff}
