...
{blank}[TODO: Clarify: When exactly should we make this roll? Before or after deployment?]
...
For a simple variation that can represent other historical battles, if both players agree, simply allow the Space Marines to use drop pods to deploy (see xref:scenario-special-rules:drop-pods.adoc[]).
