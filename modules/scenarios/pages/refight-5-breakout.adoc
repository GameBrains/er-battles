...
Remember that the idea is for both players to have fun, not for one side to turn the game into a one-sided stomp-fest.

Conversely, if your playing area is more than the standard 120 cm deep, the attacker may struggle to cross it in time -- so in that case, we suggest that you increase the game length by one turn for every additional 30 cm of depth.
...
* Deploy within the Attacker's deployment zone A (see <<Maps>>).
...
The role of the Attacker is perhaps a bit easier than that of the Defender, and so the Attacker's tactical considerations are a little more straightforward.

---

You'll probably be tempted to invest all of your available points on fast units -- including transport vehicles for as much of your infantry as possible -- and then use March and Assault orders to push hard across the playing area.
However, aside from the possibility of over-doing it with highly mobile armies such as Space Marines -- assuming you have the right miniatures to mechanise your entire army -- it is important to bear in mind that troop transports do offer your opponent the opportunity to increase the effect of their firepower, as each hit they get on a transport vehicle may also cause hits on the cargo troops too.

So, consider a more balanced approach: If you include some detachments that have powerful ranged units, you can put these on Overwatch orders (or at least not on March or Assault orders) and lay down strong covering fire.
This will ensure that the Shooting phase doesn't become too much of a one-sided affair in favour of the Defender.
It's better to force the Defender to be mindful about incoming fire -- and by destroying some enemy units with your shooting you minimise casualties among your assault detachments, and the Blast markers that you place on enemy detachments are important in your assaults too.
...
This is likely to mean that they can easily whittle down your detachments to half-strength or less so that they don't qualify for your victory conditions.
...
* Position your close-combat specialists much closer to the centre of the playing area, so that you can threaten and vulnerable targets with an assault in the first turn of the game.

---

Remember that attack is the best form of defence, and that it pays to concentrate your attacks.
Prioritise, and focus on breaking a small number of enemy detachments at a time -- you may have a target-rich environment, but don't get distracted by tempting fresh targets that will only serve to spread your fire more thinly!

But, once you've reduced a given enemy detachment to half strength, don't waste any further attacks on it if you can shift your attacks to more important targets (that is, those that are still above half strength and therefore valid for your opponent's victory conditions).
