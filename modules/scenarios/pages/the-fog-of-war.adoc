...
A good way to approach this is to play two or three The Fog of War battles in one sitting to give things a chance to even out.
====

TIP: The Fog of War can also be useful for campaigns -- you can use it as-is, to effectively generate randomised scenarios in your campaign, you can use it for inspiration for your own scenarios, or you can arrange things so that the players must allocate their forces between several different missions.
...
*Discovering your opponent's mission*: During the course of the game, you may be able to discover the nature of your opponent's secret mission.
...
In the Rally phase of each turn both players roll a D6; if a player equals or beats the score shown below his opponent must reveal his mission.
+
--
...
--
+
If your Supreme Commander unit is in the playing area when you make the die roll then you may re-roll the die.
...
In the Rally phase, roll a D6 for every {psyker} unit that you have within 45 cm of any enemy unit: On a roll of 6 your Psykers perceive the enemy's plans; your opponent must reveal the face of their playing card, and thus their mission.
